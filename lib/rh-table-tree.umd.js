(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["rh-table-tree"] = factory(require("vue"));
	else
		root["rh-table-tree"] = factory(root["Vue"]);
...
// CONCATENATED MODULE: ./node_modules/_cache-loader@4.1.0@cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"7500f668-vue-loader-template"}!./node_modules/_vue-loader@15.9.3@vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/_cache-loader@4.1.0@cache-loader/dist/cjs.js??ref--0-0!./node_modules/_vue-loader@15.9.3@vue-loader/lib??vue-loader-options!./packages/table-tree.vue?vue&type=template&id=f2a23fcc&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"rh-table-tree el-table el-table--border"},[_c('div',{ref:"hiddenColumns",staticClass:"hidden-columns"},[_vm._t("default")],2),_c('div',{staticClass:"rh-table-header el-table__header-wrapper"},[(_vm.showCheckbox)?_c('div',{staticClass:"rh-check-header"},[_c('el-checkbox',{attrs:{"disabled":_vm.store.states.data && _vm.store.states.data.length === 0,"indeterminate":_vm.store.states.selection.length > 0 && !_vm.isAllSelected},nativeOn:{"click":function($event){return _vm.toggleAllSelection($event)}},model:{value:(_vm.isAllSelected),callback:function ($$v) {_vm.isAllSelected=$$v},expression:"isAllSelected"}})],1):_vm._e(),_c('tt-header',{ref:"ttHeader",style:({width:_vm.layout.bodyWidth?_vm.layout.bodyWidth+'px':'',marginLeft:_vm.showCheckbox?'5px':'24px'}),attrs:{"store":_vm.store,"border":_vm.border}})],1),_c('div',{ref:"bodyWrapper",staticClass:"rh-table-wrapper",staticStyle:{"height":"calc(100% - 48px)"}},[_c('div',{staticClass:"table-wrapper",staticStyle:{"height":"100%"}},[_c('el-scrollbar',{staticStyle:{"height":"100%","width":"100%","overflow-x":"hidden"},attrs:{"wrapClass":"scroll-wrap","viewClass":"scroll-view"}},[_c('table',{staticClass:"el-table-header",staticStyle:{"width":"100%"},attrs:{"cellspacing":"0","cellpadding":"0","border":"0"}},[(_vm.showCheckbox)?[_c('el-tree',{ref:"rhTree",staticClass:"tableTree",attrs:{"data":_vm.data,"show-checkbox":"","defaultExpandAll":_vm.defaultExpandAll,"props":_vm.treeProps,"node-key":_vm.nodeKey},on:{"check-change":_vm.checkChange},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var node = ref.node;
var data = ref.data;
return [_c('tt-body',{ref:"ttBody",style:({width:_vm.layout.bodyWidth?_vm.layout.bodyWidth+'px':''}),attrs:{"node":node,"layout":_vm.layout,"data":data,"context":_vm.context,"row-class-name":_vm.rowClassName,"row-style":_vm.rowStyle,"highlight":_vm.highlightCurrentRow,"store":_vm.store}})]}}],null,false,3492083127)})]:[_c('el-tree',{ref:"rhTree",staticClass:"tableTree",attrs:{"data":_vm.data,"props":_vm.treeProps,"defaultExpandAll":_vm.defaultExpandAll,"node-key":_vm.nodeKey},on:{"check-change":_vm.checkChange},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var node = ref.node;
var data = ref.data;
return [_c('tt-body',{ref:"ttBody",style:({width:_vm.layout.bodyWidth?_vm.layout.bodyWidth+'px':''}),attrs:{"node":node,"layout":_vm.layout,"data":data,"context":_vm.context,"row-class-name":_vm.rowClassName,"row-style":_vm.rowStyle,"highlight":_vm.highlightCurrentRow,"store":_vm.store}})]}}])})],_c('el-tooltip',{ref:"tooltip",attrs:{"effect":_vm.tooltipEffect,"placement":"top","content":_vm.tooltipContent}})],2)])],1)]),_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.resizeProxyVisible),expression:"resizeProxyVisible"}],ref:"resizeProxy",staticClass:"el-table__column-resize-proxy"})])}
var staticRenderFns = []


// CONCATENATED MODULE: ./packages/table-tree.vue?vue&type=template&id=f2a23fcc&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/_@babel_runtime@7.11.0@@babel/runtime/helpers/esm/classCallCheck.js
function _classCallCheck(instance, Constructor) {
  if (!(instance instanceof Constructor)) {
    throw new TypeError("Cannot call a class as a function");
  }
}
// CONCATENATED MODULE: ./node_modules/_@babel_runtime@7.11.0@@babel/runtime/helpers/esm/createClass.js
...
// CONCATENATED MODULE: ./packages/layout.js
...
var layout_TableTreeLayout = /*#__PURE__*/function () {
  function TableTreeLayout(options) {
    _classCallCheck(this, TableTreeLayout);
  ...
  _createClass(TableTreeLayout, [{
    ...
    value: function updateElsHeight() {
      ...
      var noneHeader = this.headerDisplayNode(headerTrElm);
      ...
      this.fixedBodyHeight = this.bodyHeight; // const noData = !(this.store.states.data && this.store.states.data.length)
    ...
    value: function notifyObservers(event) {
      ...
      observers.forEach(function (observer) {
        switch (event) {
          case 'columns':
            observer.onColumnsChange(_this2);
            break;

          case 'scrollable':
            observer.onScrollableChange(_this2);
            break;

          default:
            throw new Error("Table Tree Layout don't have event ".concat(event));
        }
      });
    }
  }]);

  return TableTreeLayout;
}();

/* harmony default export */ var packages_layout = (layout_TableTreeLayout);
...
// CONCATENATED MODULE: ./packages/store/watcher.js
  ...
  methods: {
    ...
    _toggleAllSelection: function _toggleAllSelection() {
      ...
      table.$nextTick(function () {
        ...
        _this.table.$emit('select-all', states.selection);
      });
    },
    ...
    updateAllSelected: function updateAllSelected() {
      ...
      table.$nextTick(function () {
        var rhTree = table.rhTree;
        var data = states.data;
        var halfCheckedNodes = rhTree.getHalfCheckedNodes();
        var checkedNodes = rhTree.getCheckedNodes();
        var checkedLeafNodes = rhTree.getCheckedNodes(true);
        var level1DisLen = checkedNodes.length - checkedLeafNodes.length;
...
/* harmony default export */ var packages_store = (watcher);
// CONCATENATED MODULE: ./node_modules/_throttle-debounce@2.2.1@throttle-debounce/index.esm.js
...
// CONCATENATED MODULE: ./packages/store/helper.js
...
// CONCATENATED MODULE: ./packages/layout-observer.js
...
// CONCATENATED MODULE: ./packages/header.js
...
/* harmony default export */ var header = ({
  ...
  render: function render(h) {
    ...
    var orginColumns = this.store.states.originColumns;
    var columnRows = convertToRows(orginColumns, this.columns);
    return h("table", {
  ...
  methods: {
    ...
    getHeaderCellClass: function getHeaderCellClass(rowIndex, columnIndex, row, column) {
      var classes = [column.id, column.order, column.headerAlign, column.className, column.labelClassName]; // if (rowIndex === 0 && this.isCellHidden(columnIndex, row)) {
...
// CONCATENATED MODULE: ./packages/body.js
...
/* harmony default export */ var body = ({
  ...
  methods: {
    getSpan: function getSpan(row, column, columnIndex) {
      var rowspan = 1;
      var colspan = 1;
    ...
    getColspanRealWidth: function getColspanRealWidth(columns, colspan, cellIndex) {
      if (colspan < 1) {
    ...
    getCellStyle: function getCellStyle(columnIndex, row, column) {
    ...
    getCellClass: function getCellClass(columnIndex, row, column) {
      var classes = [column.id, column.align, column.className, 'td'];
    ...
    handleCellMouseEnter: function handleCellMouseEnter(event, row) {
      ...
      if ((rangeWidth + padding > cellChild.offsetWidth || cellChild.scrollWidth > cellChild.offsetWidth) && table.$refs.tooltip) {
        var tooltip = table.$refs.tooltip;
    ...
    rowRender: function rowRender(row) {
      ...
      return h("tr", {
        "class": "tr table-tree-item",
        "style": "display:flex;flex-wrap:nowrap;height:100%;box-sizing:border-box;"
      }, [columns.map(function (column, cellIndex) {
        var _this$getSpan = _this.getSpan(row, column, cellIndex),
        ...
        return h("td", {
          ...
          "class": _this.getCellClass(cellIndex, row, column),
          "attrs": {
            "rowspan": rowspan,
            "colspan": colspan
          },
        ...
        }, [column.renderCell.call(_this._renderProxy, _this.$createElement, data)]);
      })]);
    }
  }
});
...
// CONCATENATED MODULE: ./node_modules/_cache-loader@4.1.0@cache-loader/dist/cjs.js??ref--12-0!./node_modules/_thread-loader@2.1.3@thread-loader/dist/cjs.js!./node_modules/_babel-loader@8.1.0@babel-loader/lib!./node_modules/_cache-loader@4.1.0@cache-loader/dist/cjs.js??ref--0-0!./node_modules/_vue-loader@15.9.3@vue-loader/lib??vue-loader-options!./packages/table-tree.vue?vue&type=script&lang=js&
...
/* harmony default export */ var table_treevue_type_script_lang_js_ = ({
  ...
  data: function data() {
    ...
    var layout = new packages_layout({
      store: this.store,
      table: this,
      fit: this.fit,
  ...
  methods: {
    ...
    checkChange: function checkChange(dataNode, isCheck, childHasCheck) {
      var _this3 = this;

      var rhTree = this.rhTree;
      this.store.updateAllSelected();
      throttle(100, function () {
        return _this3.$emit('check-change', dataNode, isCheck, childHasCheck, rhTree);
      });
    }
  }
});
// CONCATENATED MODULE: ./packages/table-tree.vue?vue&type=script&lang=js&
 /* harmony default export */ var packages_table_treevue_type_script_lang_js_ = (table_treevue_type_script_lang_js_); 
// EXTERNAL MODULE: ./packages/table-tree.vue?vue&type=style&index=0&id=f2a23fcc&lang=scss&scoped=true&
var table_treevue_type_style_index_0_id_f2a23fcc_lang_scss_scoped_true_ = __webpack_require__("e081");
...
// CONCATENATED MODULE: ./packages/table-tree.vue
...
var component = normalizeComponent(
  packages_table_treevue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var table_tree = (component.exports);
...
function treeCellPrefix(h, _ref2) {
  var row = _ref2.row,
...
// CONCATENATED MODULE: ./packages/column.js
...
var columnIdSeed = 1;
/* harmony default export */ var packages_column = ({
  ...
  created: function created() {
    ...
    this.columnId = (parent.tableId || parent.columnId) + '_column_' + columnIdSeed++; // const sortable = this.sorttable === '' ? true : this.sorttable
  ...
  methods: {
    ...
    setColumnRenders: function setColumnRenders(column) {
      ...
      var originRenderCell = column.renderCell || defaultRenderCell;
    ...
    registerNormalWatchers: function registerNormalWatchers() {
      ...
      var props = ['label', 'property', 'index', 'formatter', 'className', 'labelClassName', 'showOverflowTooltip'];
      var aliases = {
        prop: 'property',
        realAlign: 'align',
...
var components = [table_tree, packages_column];
...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_0_9_0_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_3_6_0_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_15_9_3_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_3_0_0_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_8_0_2_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_4_1_0_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_15_9_3_vue_loader_lib_index_js_vue_loader_options_table_tree_vue_vue_type_style_index_0_id_f2a23fcc_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("a5f5");
/* harmony import */ var _node_modules_mini_css_extract_plugin_0_9_0_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_3_6_0_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_15_9_3_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_3_0_0_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_8_0_2_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_4_1_0_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_15_9_3_vue_loader_lib_index_js_vue_loader_options_table_tree_vue_vue_type_style_index_0_id_f2a23fcc_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_0_9_0_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_3_6_0_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_15_9_3_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_3_0_0_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_8_0_2_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_4_1_0_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_15_9_3_vue_loader_lib_index_js_vue_loader_options_table_tree_vue_vue_type_style_index_0_id_f2a23fcc_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_0_9_0_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_3_6_0_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_15_9_3_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_3_0_0_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_8_0_2_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_4_1_0_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_15_9_3_vue_loader_lib_index_js_vue_loader_options_table_tree_vue_vue_type_style_index_0_id_f2a23fcc_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
//# sourceMappingURL=rh-table-tree.umd.js.map